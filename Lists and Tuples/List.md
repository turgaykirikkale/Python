...
why ı should use list and tuples? 
if there are 100 variables and you wanna work on it there sequence data type like list 
and you will you name_List= ["Ali", "Veli" .....] and you will print(List)

# What is the use case Devops Engineer point of view ??
your task is List of S3 buckets in particular AWS account and print all the S3 Buckets
